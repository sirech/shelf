shared_examples_for 'item controller' do |factory|
  describe '#index' do
    subject { get :index, params: { format: :json } }

    before do
      create(factory, title: 'B - Item', year: 2015)
      create(factory, title: 'A - Item', year: 2014)
      create(factory, title: 'C - Item', year: 2015)
    end
  ...
  describe '#years' do
    ...
    before do
      create(factory, year: 2011)
      create(factory, year: 2011)
      create(factory, year: 2010)
      create(factory, year: 2014)
    end
